...
def teams(request, template=""):
    teams = [
        {
            "teams": Team.objects.filter(dist="6h", year="2021", category="").order_by(
                "start_number", "id"
            ),
            "dist_name": "6ч",
        },
        {
            "teams": Team.objects.filter(dist="12h", year="2021", category="").order_by(
                "start_number", "id"
            ),
            "dist_name": "12ч",
        },
        {
            "teams": Team.objects.filter(dist="24h", year="2021", category="").order_by(
                "start_number", "id"
            ),
            "dist_name": "24ч",
        },
        {
            "teams": Team.objects.filter(category="24h", year="2021").order_by(
                "start_number", "id"
            ),
            "dist_name": '"Братство кольца" (24ч, 4-6 человек)',
        },
        {
            "teams": Team.objects.filter(category="12h_team", year="2021").order_by(
                "start_number", "id"
            ),
            "dist_name": '"Две крепости" (12ч, 4-6 человек)',
        },
        {
            "teams": Team.objects.filter(category="12h_mw", year="2021").order_by(
                "start_number", "id"
            ),
            "dist_name": '"Две крепости" (12ч, МЖ)',
        },
        {
            "teams": Team.objects.filter(category="12h_ww", year="2021").order_by(
                "start_number", "id"
            ),
        ...
        {
            "teams": Team.objects.filter(category="6h", year="2021").order_by(
                "start_number", "id"
            ),
    ...
    teams = [
        {
            "teams": Team.objects.filter(
                paid_sum__gt=1, category="6h", start_time__isnull=True, year=2021
            ),
        ...
        {
            "teams": Team.objects.filter(
                paid_sum__gt=1, category="24h", start_time__isnull=True, year=2021
            ),
            "dist_name": "Дистанция 24ч",
        },
        {
            "teams": Team.objects.filter(
                paid_sum__gt=1, start_time__isnull=False, year=2021
            ).order_by("start_time"),
...
def teams_finish(request):
    teams = [
        {
            "teams": Team.objects.filter(
                paid_sum__gt=1, category="6h", finish_time__isnull=True, year=2021
        ...
        {
            "teams": Team.objects.filter(
                paid_sum__gt=1, category="24h", finish_time__isnull=True, year=2021
            ).order_by("start_number"),
            "dist_name": "Дистанция 24ч",
        },
        {
            "teams": Team.objects.filter(
                paid_sum__gt=1, finish_time__isnull=False, year=2021
...
def teams_protocol(request):
    teams = [
        ...
        {
            "teams": Team.objects.filter(
                paid_sum__gt=1, category__startswith="12h", year=2021
            ),
            "dist_name": "Дистанция 12ч",
        },
        {
...
def update_protocol(request):
    ...
    for tab in sheet_tabs:
        ...
        # export teams
        Team().update_places()
        teams = Team.objects.filter(category=tab, year="2021").order_by(
            "place", "start_number"
        )
